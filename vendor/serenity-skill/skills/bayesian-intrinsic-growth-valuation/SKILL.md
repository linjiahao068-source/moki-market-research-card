...
- 10-K and 10-Q trend baselines for the prior, and 8-K/earnings-release data for the newest update
...
Use this structure for company analysis:
...
- Distinguish structural growth from cyclical rebound or one-off order timing.
