...
export const nvdaResearchCard: ResearchCard = {
  ...
  ticker: 'NVDA',
  companyName: 'NVIDIA',
  title: 'NVDA｜Executive Investment View',
  subtitle: '围绕 AI 算力需求、Blackwell 交付、云厂商 capex 和证据缺口的执行视图',
  cardType: 'executive-investment-view',
...
export const tslaResearchCard: ResearchCard = {
  ...
  ticker: 'TSLA',
  companyName: 'Tesla',
  title: 'TSLA｜Executive Investment View',
  subtitle: '围绕交付、汽车毛利率、储能、FSD 叙事和证据缺口的执行视图',
  cardType: 'executive-investment-view',
  updatedAt: '2026-06-16',
  isMock: false,
  isSnapshot: true,
